...
class newMicrobe:
    def __init__(self, surface : pygame.surface.Surface, pos : pygame.Vector2, cell_size, customGene : list = empty_gene, hasParent = False, energy = initial_energy , initialDirectionIndex = 0) -> None:
    ...
    def update(self):
        self.move()
        self.energy -= energy_lost_per_tick
    ...
    def move(self):
        ...
        self.energy -= move_cost[gene_dir]
